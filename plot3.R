...
plot(datetime, monthData$Sub_metering_1, type="l", ylab="Energy Submetering", xlab="")
lines(datetime, monthData$Sub_metering_2, type="l", col="red")
lines(datetime, monthData$Sub_metering_3, type="l", col="blue")
